  ...
  return (
    <div className="landing-container">
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <div className="hero-cta">
            <button onClick={() => navigate("/zerch")} className="cta-primary">
              Go to Dashboard
            </button>
      ...
      <section className="features-section" id="features">
        ...
        <div className="features-grid">
          <div className="feature-card">
            ...
            <p>
              Sub-millisecond query response times with advanced indexing
              algorithms
            </p>
          </div>
          <div className="feature-card">
            ...
            <p>
              Find what you mean, not just what you type with AI-powered
              embeddings
            </p>
          </div>
          <div className="feature-card">
            ...
            <h4>Log Analysis</h4>
            <p>
              Search and analyze millions of log entries with natural language
              queries
            </p>
          </div>
          <div className="feature-card">
            ...
            <p>
              Built for scalability, reliability, and production-ready
              performance
            </p>
          </div>
        </div>
      ...
      <section className="tech-section" id="tech">
        ...
        <div className="tech-stack">
          <div className="tech-item">
            <h4>Rust Backend</h4>
            <p>
              Memory-safe, blazing-fast performance with zero-cost abstractions
            </p>
          </div>
          <div className="tech-item">
            <h4>Vector Embeddings</h4>
            <p>
              Leverage sentence-transformers for semantic understanding of text
            </p>
          </div>
          <div className="tech-item">
          ...
          <div className="tech-item">
            ...
            <p>
              Modern, responsive UI built with React and neobrutalism design
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="cta-section">
        ...
        <p>
          Jump into the dashboard and start searching your log data with
          AI-powered semantics
        </p>
        <button onClick={() => navigate("/zerch")} className="cta-button">
